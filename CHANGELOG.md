...
- Reduce the standing cost of having the server connected by 25%. `apexlog_list_slow_operations` is the one tool that costs more, by 53%, for what it now selects and returns ([#87], [#101], [#103], [#108], [#120], [#126], [#127])
