...
1. **Check out the [open issues](https://github.com/certinia/debug-log-analyzer-mcp/issues)** first to see if your idea or bug has already been reported.
...
For detailed instructions on setting up your development environment, refer to the [Development Guide](https://github.com/certinia/debug-log-analyzer-mcp/blob/main/DEVELOPING.md).
